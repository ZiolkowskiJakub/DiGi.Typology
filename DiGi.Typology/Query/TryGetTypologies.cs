...
namespace DiGi.Typology
{
    public static partial class Query
    {
        ...
        public static bool TryGetTypologies(this Classes.Typology? typology, TypologyPath? typologyPath, string name, out List<Classes.Typology>? typologies)
        {
            typologies = null;
            ...
            if (typology.SubTypology(typologyPath) is not Classes.Typology typology_Temp)
            {
                return false;
            }
            ...
            if (typology_Temp.SubTypologies is List<Classes.Typology> subTypologies)
            {
        ...
        /// <param name="typologies">When this method returns, contains a list of matching typologies if successful; otherwise, null.</param>
        /// <returns>True if one or more matching typologies were found; otherwise, false.</returns>
        public static bool TryGetTypologies(this Classes.Typology? typology, IEnumerable<int> values, string name, out List<Classes.Typology>? typologies)
        {
            typologies = null;
        ...
        /// <param name="typologies">When this method returns, contains a list of matching typologies if successful; otherwise, null.</param>
        /// <returns>True if one or more matching typologies were found; otherwise, false.</returns>
        public static bool TryGetTypologies(this Classes.Typology? typology, string name, out List<Classes.Typology>? typologies)
        {
